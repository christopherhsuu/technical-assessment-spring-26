        ...
        >
          ...
          <section className="mb-12">
            ...
            <div className="bg-[#0f172a] border-4 border-[#22d3ee] p-8 my-8">
              <p className="text-[#f8fafc] text-2xl font-sans leading-relaxed mb-0">
                <strong className="text-[#22d3ee]">"If this player got injured and we had to replace them with a freely available
          ...
          <section className="mb-12">
            ...
            <div className="bg-white border-2 border-[#e2e8f0] p-8 my-8">
              ...
              <p className="font-mono text-lg mb-6 text-gray-800 bg-[#f8fafc] p-4 border-l-4 border-[#3b82f6]">
          ...
          <section className="mb-12">
            ...
            <div className="bg-[#f8fafc] border-2 border-[#e2e8f0] p-6 my-6">
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b-4 border-[#0f172a]">
                    ...
                    <th className="text-left py-4 font-display font-black text-[#0f172a] text-lg">Player Tier</th>
                    <th className="text-left py-4 font-display font-black text-[#0f172a] text-lg">What This Means</th>
                  </tr>
                </thead>
                <tbody className="divide-y-2 divide-[#e2e8f0]">
                  <tr className="hover:bg-[#f8fafc] transition-colors">
                    ...
                    <td className="py-4 text-sm text-gray-600 font-sans">Bench player, struggling starter, easily replaced</td>
                  </tr>
                  <tr className="hover:bg-[#f8fafc] transition-colors">
                    ...
                    <td className="py-4 text-sm text-gray-600 font-sans">Useful bench piece, platoon player, spot starter</td>
                  </tr>
                  <tr className="hover:bg-[#f8fafc] transition-colors">
                    ...
                    <td className="py-4 text-sm text-gray-600 font-sans">Everyday player, reliable contributor, good not great</td>
                  </tr>
                  <tr className="hover:bg-[#f8fafc] transition-colors">
                    <td className="py-4 font-mono font-bold text-lg text-[#1e293b]">3-4</td>
                    <td className="py-4 font-semibold text-gray-800">Above Average</td>
                    <td className="py-4 text-sm text-gray-600 font-sans">Quality starter, fringe All-Star, team asset</td>
                  </tr>
                  <tr className="hover:bg-[#f8fafc] transition-colors">
                    <td className="py-4 font-mono font-bold text-lg text-[#06b6d4]">4-5</td>
                    <td className="py-4 font-semibold text-gray-800">All-Star</td>
                    <td className="py-4 text-sm text-gray-600 font-sans">Elite player, team cornerstone, perennial All-Star</td>
                  </tr>
                  <tr className="hover:bg-[#f8fafc] transition-colors">
                    <td className="py-4 font-mono font-bold text-lg text-[#06b6d4]">5-6</td>
                    <td className="py-4 font-semibold text-gray-800">Superstar</td>
                    <td className="py-4 text-sm text-gray-600 font-sans">MVP candidate, franchise player, top 10-20 in baseball</td>
                  </tr>
                  <tr className="hover:bg-[#f8fafc] transition-colors">
                    <td className="py-4 font-mono font-bold text-lg text-[#22d3ee]">6+</td>
                    <td className="py-4 font-semibold text-gray-800">MVP / HOF Season</td>
                    <td className="py-4 text-sm text-gray-600 font-sans">Historic performance, best in baseball, Hall of Fame caliber</td>
                  </tr>
                </tbody>
              </table>
            </div>
          ...
          <section className="mb-12">
            ...
            <div className="bg-[#0f172a] border-4 border-[#22d3ee] p-8 my-8">
              ...
              <p className="text-[#f8fafc] mb-4 font-sans text-lg">
                From 2012-2019, Mike Trout averaged <strong className="text-[#22d3ee]">8.9 WAR per season</strong>. Over that 8-year span,
                he accumulated approximately <strong className="text-[#22d3ee]">71 WAR</strong>.
              </p>
              <p className="text-[#e2e8f0] text-sm italic mb-4 font-sans">
                Translation: Compared to a replacement-level player, Trout added about 71 wins to the Angels' record over 8 seasons.
                That's roughly <strong className="text-[#06b6d4]">9 extra wins per year</strong> — the difference between 81-81 (mediocre) and
                90-72 (playoff contender).
              </p>
              <p className="text-[#e2e8f0] font-sans">
                At approximately $8-10 million per win on the free agent market, Trout was providing <strong className="text-[#22d3ee]">$70-90 million</strong>
