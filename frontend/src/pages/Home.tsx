        ...
        >
          ...
          <Link to="/war">
            <motion.button
              ...
              className="group relative inline-flex items-center px-12 py-6 bg-[#3b82f6] border-4 border-[#22d3ee] shadow-[10px_10px_0px_rgba(34,211,238,0.28)] hover:shadow-[14px_14px_0px_rgba(34,211,238,0.35)] transition-all"
            >
              <span className="font-display font-black text-2xl text-white tracking-tight mr-6">
                BEGIN WITH WAR
              </span>
              <div className="w-12 h-12 bg-[#22d3ee] flex items-center justify-center rounded-sm group-hover:animate-[float_1s_ease-in-out_infinite]">
